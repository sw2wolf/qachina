...
set path = (. /sbin /bin /usr/sbin /usr/bin /usr/games /usr/local/sbin /usr/local/bin  $HOME/bin $HOME/.cabal/bin $HOME/clisp/bin $HOME/gprolog-1.4.4/bin $HOME/swi-prolog/bin)
