...
(custom-set-faces
  ...
  ;; Your init file should contain only one such instance.
  ;; If there is more than one, they won't work right.
  ;;put the cursor on some text of which you would like to change the appearance and then do M-x customize-face RET RET
 '(erc-command-indicator-face ((t (:foreground "red" :weight bold))))
